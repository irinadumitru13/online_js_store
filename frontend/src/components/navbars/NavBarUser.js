        ...
        <Navbar bg={'dark'} variant={'dark'}>
            <Container >
                ...
                <Navbar.Collapse className={'justify-content-end'}>
                    <Nav.Link className="icons-padding" href={'/wish'}>
                        <FavoriteIcon className="bkg-primary"/>
                    </Nav.Link>
                    <Nav.Link className="icons-padding2" href={'/cart'}>
                        <ShoppingCartIcon className="bkg-primary"/>
                    </Nav.Link>
